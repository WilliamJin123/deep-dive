...
# Essentially, think and analyze just add ReasoningSteps which just break up the problem down into separate steps (runs)
# where the model is actively prompted to reason and analyze to amke better decisions 
# (tool calling, better parameters, delegations, etc.) in the following steps

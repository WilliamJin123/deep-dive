...
agent = Agent(
    ...
    # Enable automatic context inclusion of message history
    add_history_to_context=True,
    num_history_runs=10,  # Include last 10 interactions
    read_chat_history=True,  # Give the agent access to get_chat_history tool
...
print("Chat history so far:", chat_history)
...
# Final chat history
final_chat_history = agent.get_chat_history()
print("Complete chat history:", final_chat_history)